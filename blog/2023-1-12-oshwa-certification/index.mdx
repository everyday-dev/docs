...
keywords: [oshwa, certification, greatlakesdev]
description: Great lakes dev receives OSHWA certification for breadboard-io and atmega32u4_breakout boards
# image: tbd
---
...
![img](oshw_cert_breadboardio.svg)
![img](oshw_cert_atmega32u4_breakout.svg)
