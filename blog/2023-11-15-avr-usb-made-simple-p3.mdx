...
title: AVR USB Made Simple - Interrupt Transfers
authors: stephen
...
description: "A multi-part introduction to USB on AVR microcontrollers. In Part 3 we cover the implementation of Interrupt transfers."
