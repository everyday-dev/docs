...
embedded journeys. In pursuit of our mission, we plan to post content on a more regular basis, including deep dives for embedded concepts and creating more open source hardware and firmware proejcts.
