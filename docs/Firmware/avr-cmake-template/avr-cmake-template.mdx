...
:::note
These commands require the USB-DFU bootloader to be present and enumerated on your microcontroller.
:::
To erase the connected target:
```console
make dfu_erase
...
:::tip Next steps
With your project set up and ready to go, checkout this Advanced guide on [flashing the DFU bootloader](/docs/atmega32u4_breakout/advanced-guides/flashing-dfu-bootloader) to make it quick and
easy to flash your applications using a single USB cable.
:::
