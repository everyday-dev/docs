...
```
- Install the ```avr-gcc``` toolchain using the installer provided on the [Microchip site](https://www.microchip.com/en-us/tools-resources/develop/microchip-studio/gcc-compilers).
