...
<a href="https://certification.oshwa.org/us002159.html" target="_blank">
    <img height='125' width='125' style={{float:'right',}} src="/img/oshw_cert_breadboardio.svg" />
</a>
...
schematic and 3d STEP model <a href="https://www.github.com/everyday-dev/breadboard-io" target="_blank">on Github</a>.
:::
...
:::note
The SWx output signals have a 10k ohm padding resistor to protect from any shorts between the VCC rail and GND. The SWx signals are fine for direct connection to a microcontroller or other high impedence circuits
