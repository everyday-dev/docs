...
with a single USB Type C cable. Using the ISP programmer can be easiest when at a bench and your actively developing your application and constantly reflashing to test. The
...
commands in the [avr-cmake-template](/docs/avr-cmake-template) or reflash the board using [```dfu-programmer```](https://github.com/dfu-programmer/dfu-programmer) directly
