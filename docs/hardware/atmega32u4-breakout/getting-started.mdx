...
description: Getting started guide for the atmega32u4 breakout board by everyday⚡dev
# image: tbd
---
The default setup for the atmega32u4 breakout board is ready to use in ```bare-metal``` projects and we highly recommend you use our [avr-cmake-template](https://github.com/everyday-dev/avr-cmake-template)
